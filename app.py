...
st.title("KPI and Outcome Suggestion Directory")

# Sector selection
sector = st.selectbox("Select Government Sector:", list(kpi_directory.keys()))
...
if sector:
    ...
    if mda:
        ...
        st.markdown(f"**{kpi_directory[sector][mda]['outcome']}**")
